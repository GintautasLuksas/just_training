...
SEED_TASKS = [
    ...
    },
    {
        ...
        "prompt": "Operations needs a driver earnings dashboard. Include drivers with no completed paid trips so no one disappears from the report.",
        ...
        "hint2": "Start from drivers, LEFT JOIN trips, group by driver. Show driver_name, total_trips, total_earnings, and avg_trip_price. Put drivers with NULL totals last.",
